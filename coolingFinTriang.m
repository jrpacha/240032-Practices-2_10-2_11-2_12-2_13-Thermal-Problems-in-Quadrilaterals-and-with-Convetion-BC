%% Engine Cooling fin (Triangle mesh)
clearvars
close all

fileName='tempCoolingFinTriang.xlsx'; %Excel file to write the results in
...
indCV=unique(indCV);      %just to avoid repeated indices
